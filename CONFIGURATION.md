...
The selected value is stored centrally in Azure Table Storage and applies to all users and devices. Participant positions are determined by the order in the text box or uploaded file. Uploaded files should contain one name per row in the first column. Supported formats are TXT, CSV, XLS and XLSX.
